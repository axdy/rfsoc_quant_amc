-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/amc_model_w8a16_4x2/amc_cnn_8w16a_4x2_src_adder_0_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_8w16a_4x2_src_adder_0_block
-- Source Path: amc_model_w8a16_4x2/DUT HDL/Conv Layer 1/Layer 1 Mat-Vec Multiplier/adder 0
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_8w16a_4x2_src_adder_0_block IS
...
END amc_cnn_8w16a_4x2_src_adder_0_block;


ARCHITECTURE rtl OF amc_cnn_8w16a_4x2_src_adder_0_block IS
  ...
  SIGNAL In1_signed                       : signed(7 DOWNTO 0);  -- sfix8_En7
  SIGNAL Multiply_Accumulate_in1_buff_in_pipe_reg : vector_of_signed8(0 TO 1);  -- sfix8 [2]
  SIGNAL Multiply_Accumulate_in1_buff_in_pipe_reg_next : vector_of_signed8(0 TO 1);  -- sfix8_En7 [2]
  SIGNAL In1_1                            : signed(7 DOWNTO 0);  -- sfix8_En7
  ...
  SIGNAL Data_Type_Conversion_out1        : signed(15 DOWNTO 0);  -- sfix16_En16
...
BEGIN
  ...
  Multiply_Accumulate_add_add_cast_1 <= resize(Multiply_Accumulate_multiply_out_1 & '0' & '0' & '0' & '0' & '0' & '0' & '0', 35);
  ...
  Data_Type_Conversion_out1 <= Multiply_Accumulate_out1_2(27 DOWNTO 12);
