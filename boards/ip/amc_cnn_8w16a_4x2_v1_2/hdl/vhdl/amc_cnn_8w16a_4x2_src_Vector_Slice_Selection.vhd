-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/amc_model_w8a16_4x2/amc_cnn_8w16a_4x2_src_Vector_Slice_Selection.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_8w16a_4x2_src_Vector_Slice_Selection
-- Source Path: amc_model_w8a16_4x2/DUT HDL/Conv Layer 2/Vector Slice Selection
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_8w16a_4x2_src_Vector_Slice_Selection IS
...
END amc_cnn_8w16a_4x2_src_Vector_Slice_Selection;


ARCHITECTURE rtl OF amc_cnn_8w16a_4x2_src_Vector_Slice_Selection IS

  -- Component Declarations
  COMPONENT amc_cnn_8w16a_4x2_src_Frame_Slicer
  ...
  COMPONENT amc_cnn_8w16a_4x2_src_Frame_Slicer1
    PORT( frameIn                         :   IN    vector_of_std_logic_vector16(0 TO 63);  -- sfix16_En13 [64]
          slicedFrame                     :   OUT   vector_of_std_logic_vector16(0 TO 15)  -- sfix16_En13 [16]
          );
  END COMPONENT;

  COMPONENT amc_cnn_8w16a_4x2_src_Frame_Slicer2
    PORT( frameIn                         :   IN    vector_of_std_logic_vector16(0 TO 63);  -- sfix16_En13 [64]
          slicedFrame                     :   OUT   vector_of_std_logic_vector16(0 TO 15)  -- sfix16_En13 [16]
          );
  END COMPONENT;

  COMPONENT amc_cnn_8w16a_4x2_src_Frame_Slicer3
    PORT( frameIn                         :   IN    vector_of_std_logic_vector16(0 TO 63);  -- sfix16_En13 [64]
          slicedFrame                     :   OUT   vector_of_std_logic_vector16(0 TO 15)  -- sfix16_En13 [16]
          );
  END COMPONENT;
  ...
  FOR ALL : amc_cnn_8w16a_4x2_src_Frame_Slicer
    USE ENTITY work.amc_cnn_8w16a_4x2_src_Frame_Slicer(rtl);

  FOR ALL : amc_cnn_8w16a_4x2_src_Frame_Slicer1
    USE ENTITY work.amc_cnn_8w16a_4x2_src_Frame_Slicer1(rtl);

  FOR ALL : amc_cnn_8w16a_4x2_src_Frame_Slicer2
    USE ENTITY work.amc_cnn_8w16a_4x2_src_Frame_Slicer2(rtl);

  FOR ALL : amc_cnn_8w16a_4x2_src_Frame_Slicer3
    USE ENTITY work.amc_cnn_8w16a_4x2_src_Frame_Slicer3(rtl);
...
BEGIN
  u_Frame_Slicer : amc_cnn_8w16a_4x2_src_Frame_Slicer
    PORT MAP( frameIn => frameIn,  -- sfix16_En13 [64]
              slicedFrame => slicedFrame  -- sfix16_En13 [16]
              );

  u_Frame_Slicer1 : amc_cnn_8w16a_4x2_src_Frame_Slicer1
    PORT MAP( frameIn => frameIn,  -- sfix16_En13 [64]
              slicedFrame => slicedFrame_1  -- sfix16_En13 [16]
              );

  u_Frame_Slicer2 : amc_cnn_8w16a_4x2_src_Frame_Slicer2
    PORT MAP( frameIn => frameIn,  -- sfix16_En13 [64]
              slicedFrame => slicedFrame_2  -- sfix16_En13 [16]
              );

  u_Frame_Slicer3 : amc_cnn_8w16a_4x2_src_Frame_Slicer3
    PORT MAP( frameIn => frameIn,  -- sfix16_En13 [64]
