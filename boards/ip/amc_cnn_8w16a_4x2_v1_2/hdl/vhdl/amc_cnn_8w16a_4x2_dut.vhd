-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/amc_model_w8a16_4x2/amc_cnn_8w16a_4x2_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_8w16a_4x2_dut
-- Source Path: amc_cnn_8w16a_4x2/amc_cnn_8w16a_4x2_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_8w16a_4x2_dut IS
...
END amc_cnn_8w16a_4x2_dut;


ARCHITECTURE rtl OF amc_cnn_8w16a_4x2_dut IS

  -- Component Declarations
  COMPONENT amc_cnn_8w16a_4x2_src_DUT_HDL
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : amc_cnn_8w16a_4x2_src_DUT_HDL
    USE ENTITY work.amc_cnn_8w16a_4x2_src_DUT_HDL(rtl);
...
BEGIN
  u_amc_cnn_8w16a_4x2_src_DUT_HDL : amc_cnn_8w16a_4x2_src_DUT_HDL
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
