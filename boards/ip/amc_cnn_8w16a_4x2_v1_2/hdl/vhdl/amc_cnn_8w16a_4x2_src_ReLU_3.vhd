-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/amc_model_w8a16_4x2/amc_cnn_8w16a_4x2_src_ReLU_3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_8w16a_4x2_src_ReLU_3
-- Source Path: amc_model_w8a16_4x2/DUT HDL/Dense Layer 1/ReLU 3
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_8w16a_4x2_src_ReLU_3 IS
  PORT( in_rsvd                           :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En10
        out_rsvd                          :   OUT   std_logic_vector(15 DOWNTO 0)  -- sfix16_En9
        );
END amc_cnn_8w16a_4x2_src_ReLU_3;


ARCHITECTURE rtl OF amc_cnn_8w16a_4x2_src_ReLU_3 IS

  -- Signals
  SIGNAL in_signed                        : signed(15 DOWNTO 0);  -- sfix16_En10
