-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/model_qat_2x2_w4a16/amc_cnn_qat_4w16a_src_adder_0_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_qat_4w16a_src_adder_0_block1
-- Source Path: model_qat_2x2_w4a16/DUT HDL/Dense Layer 1/Dense Layer 1/adder 0
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_qat_4w16a_src_adder_0_block1 IS
...
END amc_cnn_qat_4w16a_src_adder_0_block1;


ARCHITECTURE rtl OF amc_cnn_qat_4w16a_src_adder_0_block1 IS
  ...
  SIGNAL In1_signed                       : signed(3 DOWNTO 0);  -- sfix4_En7
  SIGNAL Multiply_Accumulate_in1_buff_in_pipe_reg : vector_of_signed4(0 TO 1);  -- sfix4 [2]
  SIGNAL Multiply_Accumulate_in1_buff_in_pipe_reg_next : vector_of_signed4(0 TO 1);  -- sfix4_En7 [2]
  SIGNAL In1_1                            : signed(3 DOWNTO 0);  -- sfix4_En7
  SIGNAL Multiply_Accumulate_multiply_out : signed(19 DOWNTO 0);  -- sfix20_En21
  SIGNAL Multiply_Accumulate_multiply_out_1 : signed(19 DOWNTO 0);  -- sfix20_En21
