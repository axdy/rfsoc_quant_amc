-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/model_qat_2x2_w4a16/amc_cnn_qat_4w16a_src_nfp_convert_sfix_16_En11_to_single.vhd
-- Created: 2025-02-23 21:07:21
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_qat_4w16a_src_nfp_convert_sfix_16_En11_to_single
-- Source Path: model_qat_2x2_w4a16/DUT HDL/nfp_convert_sfix_16_En11_to_single
-- Hierarchy Level: 1
-- 
...
ENTITY amc_cnn_qat_4w16a_src_nfp_convert_sfix_16_En11_to_single IS
  PORT( clk                               :   IN    std_logic;
        reset                             :   IN    std_logic;
        enb                               :   IN    std_logic;
        nfp_in                            :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En11
        nfp_out                           :   OUT   std_logic_vector(31 DOWNTO 0)  -- ufix32
        );
END amc_cnn_qat_4w16a_src_nfp_convert_sfix_16_En11_to_single;


ARCHITECTURE rtl OF amc_cnn_qat_4w16a_src_nfp_convert_sfix_16_En11_to_single IS

  -- Signals
  SIGNAL nfp_in_signed                    : signed(15 DOWNTO 0);  -- sfix16_En11
  ...
  SIGNAL Delay_out1_dtc                   : unsigned(15 DOWNTO 0);  -- ufix16_En11
  SIGNAL Unary_Minus_cast                 : signed(16 DOWNTO 0);  -- sfix17_En11
  SIGNAL Unary_Minus_cast_1               : signed(16 DOWNTO 0);  -- sfix17_En11
  SIGNAL Unary_Minus_out1                 : signed(15 DOWNTO 0);  -- sfix16_En11
  SIGNAL Unary_Minus_out1_dtc             : unsigned(15 DOWNTO 0);  -- ufix16_En11
  SIGNAL Switch_out1                      : unsigned(15 DOWNTO 0);  -- ufix16_En11
  SIGNAL Data_Type_Conversion_out1        : unsigned(127 DOWNTO 0);  -- ufix128_En11
  ...
  SIGNAL Delay2_reg_next                  : vector_of_unsigned128(0 TO 2);  -- ufix128_En11 [3]
  SIGNAL Delay2_out1_3                    : unsigned(127 DOWNTO 0);  -- ufix128_En11
  ...
  SIGNAL Shift_Arithmetic_out1            : unsigned(127 DOWNTO 0);  -- ufix128_En11
...
BEGIN
  ...
  CompareToZero1_out1 <= '1' WHEN Delay_out1 = to_signed(16#0000#, 16) ELSE
      '0';
  ...
  Compare_To_Zero_out1 <= '1' WHEN Delay_out1 < to_signed(16#0000#, 16) ELSE
      '0';
  ...
  Unary_Minus_cast <= resize(Delay_out1, 17);
  ...
  Constant_out1 <= to_signed(16#73#, 8);
