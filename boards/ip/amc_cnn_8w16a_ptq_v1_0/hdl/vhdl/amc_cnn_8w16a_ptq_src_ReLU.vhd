-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/model_pqt_2x2_w8a16/amc_cnn_8w16a_ptq_src_ReLU.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_8w16a_ptq_src_ReLU
-- Source Path: model_pqt_2x2_w8a16/DUT HDL/Conv Layer 1/ReLU
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_8w16a_ptq_src_ReLU IS
...
END amc_cnn_8w16a_ptq_src_ReLU;


ARCHITECTURE rtl OF amc_cnn_8w16a_ptq_src_ReLU IS

  -- Signals
  SIGNAL in_signed                        : vector_of_signed16(0 TO 63);  -- sfix16_En14 [64]
