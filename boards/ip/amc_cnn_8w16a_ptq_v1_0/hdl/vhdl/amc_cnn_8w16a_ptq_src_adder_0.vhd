-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/model_pqt_2x2_w8a16/amc_cnn_8w16a_ptq_src_adder_0.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_8w16a_ptq_src_adder_0
-- Source Path: model_pqt_2x2_w8a16/DUT HDL/Dense Layer 2/Dense Layer 2/adder 0
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_8w16a_ptq_src_adder_0 IS
...
END amc_cnn_8w16a_ptq_src_adder_0;


ARCHITECTURE rtl OF amc_cnn_8w16a_ptq_src_adder_0 IS
  ...
  SIGNAL Multiply_Accumulate1_input_mux_out : signed(15 DOWNTO 0);  -- sfix16_En8
  SIGNAL In1_signed                       : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL Multiply_Accumulate1_multiply_out : signed(31 DOWNTO 0);  -- sfix32_En22
  SIGNAL Multiply_Accumulate1_multiply_out_1 : signed(31 DOWNTO 0);  -- sfix32_En22
...
BEGIN
  ...
  Multiply_Accumulate1_add_add_cast_1 <= resize(Multiply_Accumulate1_multiply_out_1 & '0' & '0' & '0' & '0', 40);
