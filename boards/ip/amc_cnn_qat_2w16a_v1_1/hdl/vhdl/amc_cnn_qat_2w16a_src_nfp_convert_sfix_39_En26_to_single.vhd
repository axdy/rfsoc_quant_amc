-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/model_qat_2x2_w2a16/amc_cnn_qat_2w16a_src_nfp_convert_sfix_39_En26_to_single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_qat_2w16a_src_nfp_convert_sfix_39_En26_to_single
-- Source Path: model_qat_2x2_w2a16/DUT HDL/nfp_convert_sfix_39_En26_to_single
-- Hierarchy Level: 1
-- 
...
ENTITY amc_cnn_qat_2w16a_src_nfp_convert_sfix_39_En26_to_single IS
...
END amc_cnn_qat_2w16a_src_nfp_convert_sfix_39_En26_to_single;


ARCHITECTURE rtl OF amc_cnn_qat_2w16a_src_nfp_convert_sfix_39_En26_to_single IS

  -- Signals
  SIGNAL nfp_in_signed                    : signed(38 DOWNTO 0);  -- sfix39_En26
  SIGNAL Delay_out1                       : signed(38 DOWNTO 0);  -- sfix39_En26
  ...
  SIGNAL Delay_out1_dtc                   : unsigned(38 DOWNTO 0);  -- ufix39_En26
  SIGNAL Unary_Minus_cast                 : signed(39 DOWNTO 0);  -- sfix40_En26
  SIGNAL Unary_Minus_cast_1               : signed(39 DOWNTO 0);  -- sfix40_En26
  SIGNAL Unary_Minus_out1                 : signed(38 DOWNTO 0);  -- sfix39_En26
  SIGNAL Unary_Minus_out1_dtc             : unsigned(38 DOWNTO 0);  -- ufix39_En26
  SIGNAL Switch_out1                      : unsigned(38 DOWNTO 0);  -- ufix39_En26
  SIGNAL Data_Type_Conversion_out1        : unsigned(127 DOWNTO 0);  -- ufix128_En26
  ...
  SIGNAL Delay2_reg_next                  : vector_of_unsigned128(0 TO 2);  -- ufix128_En26 [3]
  SIGNAL Delay2_out1_3                    : unsigned(127 DOWNTO 0);  -- ufix128_En26
  ...
  SIGNAL Shift_Arithmetic_out1            : unsigned(127 DOWNTO 0);  -- ufix128_En26
...
BEGIN
  ...
  CompareToZero1_out1 <= '1' WHEN Delay_out1 = to_signed(0, 39) ELSE
      '0';
  ...
  Compare_To_Zero_out1 <= '1' WHEN Delay_out1 < to_signed(0, 39) ELSE
      '0';
  ...
  Unary_Minus_cast <= resize(Delay_out1, 40);
  Unary_Minus_cast_1 <=  - (Unary_Minus_cast);
  Unary_Minus_out1 <= Unary_Minus_cast_1(38 DOWNTO 0);
  ...
  Constant_out1 <= to_signed(16#64#, 8);
