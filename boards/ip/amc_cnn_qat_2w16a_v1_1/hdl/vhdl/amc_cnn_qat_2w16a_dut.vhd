-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/model_qat_2x2_w2a16/amc_cnn_qat_2w16a_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_qat_2w16a_dut
-- Source Path: amc_cnn_qat_2w16a/amc_cnn_qat_2w16a_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_qat_2w16a_dut IS
...
END amc_cnn_qat_2w16a_dut;


ARCHITECTURE rtl OF amc_cnn_qat_2w16a_dut IS

  -- Component Declarations
  COMPONENT amc_cnn_qat_2w16a_src_DUT_HDL
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : amc_cnn_qat_2w16a_src_DUT_HDL
    USE ENTITY work.amc_cnn_qat_2w16a_src_DUT_HDL(rtl);
...
BEGIN
  u_amc_cnn_qat_2w16a_src_DUT_HDL : amc_cnn_qat_2w16a_src_DUT_HDL
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
