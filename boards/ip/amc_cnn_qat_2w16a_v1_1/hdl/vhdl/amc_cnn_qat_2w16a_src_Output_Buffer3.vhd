-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/model_qat_2x2_w2a16/amc_cnn_qat_2w16a_src_Output_Buffer3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_qat_2w16a_src_Output_Buffer3
-- Source Path: model_qat_2x2_w2a16/DUT HDL/Dense Layer 2/Output Buffer3
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_qat_2w16a_src_Output_Buffer3 IS
...
END amc_cnn_qat_2w16a_src_Output_Buffer3;


ARCHITECTURE rtl OF amc_cnn_qat_2w16a_src_Output_Buffer3 IS

  -- Signals
  SIGNAL vectorIn_signed                  : vector_of_signed39(0 TO 7);  -- sfix39_En26 [8]
  SIGNAL samplesOut_tmp                   : signed(38 DOWNTO 0);  -- sfix39_En26
  SIGNAL reg_flag                         : std_logic;
  SIGNAL reg_count_out                    : unsigned(3 DOWNTO 0);  -- ufix4
  SIGNAL buffer_rsvd                      : vector_of_signed39(0 TO 7);  -- sfix39 [8]
  SIGNAL reg_flag_next                    : std_logic;
  SIGNAL reg_count_out_next               : unsigned(3 DOWNTO 0);  -- ufix4
  SIGNAL buffer_next                      : vector_of_signed39(0 TO 7);  -- sfix39_En26 [8]
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        ...
        buffer_rsvd <= (OTHERS => to_signed(0, 39));
      ELSIF enb = '1' THEN
  ...
  Output_Buffer3_output : PROCESS (buffer_rsvd, reg_count_out, reg_flag, validIn, vectorIn_signed)
    ...
    VARIABLE buffer_temp : vector_of_signed39(0 TO 7);
