-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/amc_model_w16a16_4x2/amc_cnn_16w16a_4x2_src_adder_2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_16w16a_4x2_src_adder_2
-- Source Path: amc_model_w16a16_4x2/DUT HDL/Dense Layer 2/Dense Layer 2/adder 2
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_16w16a_4x2_src_adder_2 IS
...
END amc_cnn_16w16a_4x2_src_adder_2;


ARCHITECTURE rtl OF amc_cnn_16w16a_4x2_src_adder_2 IS
  ...
  SIGNAL Multiply_Accumulate1_multiply_out : signed(31 DOWNTO 0);  -- sfix32_En23
  SIGNAL Multiply_Accumulate1_multiply_out_1 : signed(31 DOWNTO 0);  -- sfix32_En23
...
BEGIN
  ...
  Multiply_Accumulate1_add_add_cast_1 <= resize(Multiply_Accumulate1_multiply_out_1 & '0' & '0' & '0', 40);
