-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/amc_model_w4a16/amc_cnn_4w16a_src_MAC14_block11.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_4w16a_src_MAC14_block11
-- Source Path: amc_model_w4a16/DUT HDL/Conv Layer 2/Filter Matrix Multiplier1/ParallelMACs 6/MAC14
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_4w16a_src_MAC14_block11 IS
...
END amc_cnn_4w16a_src_MAC14_block11;


ARCHITECTURE rtl OF amc_cnn_4w16a_src_MAC14_block11 IS
  ...
  SIGNAL countWeights_signed              : signed(7 DOWNTO 0);  -- sfix8_En6
...
BEGIN
  ...
  Data_Type_Conversion_out1 <= Multiply_Accumulate_out1_1(16 DOWNTO 1);
