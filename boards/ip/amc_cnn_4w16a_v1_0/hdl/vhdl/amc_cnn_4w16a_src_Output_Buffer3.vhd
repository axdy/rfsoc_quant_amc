-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/amc_model_w4a16/amc_cnn_4w16a_src_Output_Buffer3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_4w16a_src_Output_Buffer3
-- Source Path: amc_model_w4a16/DUT HDL/Dense Layer 2/Output Buffer3
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_4w16a_src_Output_Buffer3 IS
...
END amc_cnn_4w16a_src_Output_Buffer3;


ARCHITECTURE rtl OF amc_cnn_4w16a_src_Output_Buffer3 IS

  -- Signals
  SIGNAL vectorIn_signed                  : vector_of_signed16(0 TO 7);  -- sfix16_En1 [8]
  ...
  SIGNAL buffer_next                      : vector_of_signed16(0 TO 7);  -- sfix16_En1 [8]
