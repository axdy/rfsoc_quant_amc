-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/amc_model_w4a16/amc_cnn_4w16a_src_nfp_convert_sfix_16_En1_to_single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_4w16a_src_nfp_convert_sfix_16_En1_to_single
-- Source Path: amc_model_w4a16/DUT HDL/nfp_convert_sfix_16_En1_to_single
-- Hierarchy Level: 1
-- 
...
ENTITY amc_cnn_4w16a_src_nfp_convert_sfix_16_En1_to_single IS
...
END amc_cnn_4w16a_src_nfp_convert_sfix_16_En1_to_single;


ARCHITECTURE rtl OF amc_cnn_4w16a_src_nfp_convert_sfix_16_En1_to_single IS

  -- Signals
  SIGNAL nfp_in_signed                    : signed(15 DOWNTO 0);  -- sfix16_En1
  SIGNAL Delay_out1                       : signed(15 DOWNTO 0);  -- sfix16_En1
  ...
  SIGNAL Delay_out1_dtc                   : unsigned(15 DOWNTO 0);  -- ufix16_En1
  SIGNAL Unary_Minus_cast                 : signed(16 DOWNTO 0);  -- sfix17_En1
  SIGNAL Unary_Minus_cast_1               : signed(16 DOWNTO 0);  -- sfix17_En1
  SIGNAL Unary_Minus_out1                 : signed(15 DOWNTO 0);  -- sfix16_En1
  SIGNAL Unary_Minus_out1_dtc             : unsigned(15 DOWNTO 0);  -- ufix16_En1
  SIGNAL Switch_out1                      : unsigned(15 DOWNTO 0);  -- ufix16_En1
  SIGNAL Data_Type_Conversion_out1        : unsigned(127 DOWNTO 0);  -- ufix128_En1
  ...
  SIGNAL Delay2_reg_next                  : vector_of_unsigned128(0 TO 2);  -- ufix128_En1 [3]
  SIGNAL Delay2_out1_3                    : unsigned(127 DOWNTO 0);  -- ufix128_En1
  ...
  SIGNAL Shift_Arithmetic_out1            : unsigned(127 DOWNTO 0);  -- ufix128_En1
...
BEGIN
  ...
  Constant_out1 <= to_signed(16#7D#, 8);
