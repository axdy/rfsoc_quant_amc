-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/amc_model_w4a16/amc_cnn_4w16a_src_ReLU_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_4w16a_src_ReLU_block
-- Source Path: amc_model_w4a16/DUT HDL/Conv Layer 2/ReLU
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_4w16a_src_ReLU_block IS
...
END amc_cnn_4w16a_src_ReLU_block;


ARCHITECTURE rtl OF amc_cnn_4w16a_src_ReLU_block IS

  -- Signals
  SIGNAL in_signed                        : vector_of_signed16(0 TO 15);  -- sfix16_En5 [16]
...
BEGIN
  ...
  BEGIN
    ...
    FOR k IN 0 TO 15 LOOP
      hfi(k) := (resize(in_signed(k)(15 DOWNTO 5), 16)) + ('0' & in_signed(k)(4));
