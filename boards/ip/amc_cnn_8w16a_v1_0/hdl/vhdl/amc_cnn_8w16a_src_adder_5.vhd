-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/amc_model_w8a16/amc_cnn_8w16a_src_adder_5.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_8w16a_src_adder_5
-- Source Path: amc_model_w8a16/DUT HDL/Dense Layer 2/Dense Layer 2/adder 5
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_8w16a_src_adder_5 IS
...
END amc_cnn_8w16a_src_adder_5;


ARCHITECTURE rtl OF amc_cnn_8w16a_src_adder_5 IS
  ...
  SIGNAL Multiply_Accumulate1_multiply_out : signed(23 DOWNTO 0);  -- sfix24_En6
  SIGNAL Multiply_Accumulate1_multiply_out_1 : signed(23 DOWNTO 0);  -- sfix24_En6
  SIGNAL Multiply_Accumulate1_out1        : signed(23 DOWNTO 0);  -- sfix24_En6
  SIGNAL Multiply_Accumulate1_add_fb_in   : signed(23 DOWNTO 0);  -- sfix24_En6
  SIGNAL Multiply_Accumulate1_multiplyAdd_out : signed(23 DOWNTO 0);  -- sfix24_En6
  SIGNAL Multiply_Accumulate1_out1_1      : signed(23 DOWNTO 0);  -- sfix24_En6
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Multiply_Accumulate1_multiply_out_1 <= to_signed(16#000000#, 24);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Multiply_Accumulate1_out1 <= to_signed(16#000000#, 24);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Multiply_Accumulate1_out1_1 <= to_signed(16#000000#, 24);
      ELSIF enb = '1' THEN
  ...
  Data_Type_Conversion_out1 <= Multiply_Accumulate1_out1_1(21 DOWNTO 6);
