-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/amc_model_w8a16/amc_cnn_8w16a_src_nfp_convert_sfix_16_En0_to_single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_8w16a_src_nfp_convert_sfix_16_En0_to_single
-- Source Path: amc_model_w8a16/DUT HDL/nfp_convert_sfix_16_En0_to_single
-- Hierarchy Level: 1
-- 
...
ENTITY amc_cnn_8w16a_src_nfp_convert_sfix_16_En0_to_single IS
...
END amc_cnn_8w16a_src_nfp_convert_sfix_16_En0_to_single;


ARCHITECTURE rtl OF amc_cnn_8w16a_src_nfp_convert_sfix_16_En0_to_single IS

  -- Signals
  SIGNAL nfp_in_signed                    : signed(15 DOWNTO 0);  -- int16
  SIGNAL Delay_out1                       : signed(15 DOWNTO 0);  -- sfix16
  ...
  SIGNAL Delay_out1_dtc                   : unsigned(15 DOWNTO 0);  -- ufix16
  SIGNAL Unary_Minus_in0                  : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL Unary_Minus_out1                 : signed(15 DOWNTO 0);  -- sfix16
  SIGNAL Unary_Minus_out1_dtc             : unsigned(15 DOWNTO 0);  -- ufix16
  ...
  SIGNAL Delay2_reg_next                  : vector_of_unsigned128(0 TO 2);  -- ufix128 [3]
  SIGNAL Delay2_out1_3                    : unsigned(127 DOWNTO 0);  -- ufix128
  SIGNAL dynamic_shift_zerosig            : signed(8 DOWNTO 0);  -- sfix9
  SIGNAL dynamic_shift_selsig             : signed(8 DOWNTO 0);  -- sfix9
  SIGNAL Shift_Arithmetic_out1            : unsigned(127 DOWNTO 0);  -- ufix128
...
BEGIN
  ...
  Unary_Minus_in0 <=  - (resize(Delay_out1, 17));
  Unary_Minus_out1 <= Unary_Minus_in0(15 DOWNTO 0);
  ...
  Constant_out1 <= to_signed(16#7E#, 8);
  ...
  Shift_Arithmetic_out1 <= Delay2_out1_3 sll to_integer(dynamic_shift_selsig);
