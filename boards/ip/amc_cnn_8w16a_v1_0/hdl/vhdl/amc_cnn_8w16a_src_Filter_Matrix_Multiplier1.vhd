-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/amc_model_w8a16/amc_cnn_8w16a_src_Filter_Matrix_Multiplier1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_8w16a_src_Filter_Matrix_Multiplier1
-- Source Path: amc_model_w8a16/DUT HDL/Conv Layer 2/Filter Matrix Multiplier1
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_8w16a_src_Filter_Matrix_Multiplier1 IS
...
END amc_cnn_8w16a_src_Filter_Matrix_Multiplier1;


ARCHITECTURE rtl OF amc_cnn_8w16a_src_Filter_Matrix_Multiplier1 IS

  -- Component Declarations
  COMPONENT amc_cnn_8w16a_src_ParallelMACs_0
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT amc_cnn_8w16a_src_ParallelMACs_1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          vectorIn                        :   IN    vector_of_std_logic_vector16(0 TO 15);  -- int16 [16]
  ...
  COMPONENT amc_cnn_8w16a_src_ParallelMACs_2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          vectorIn                        :   IN    vector_of_std_logic_vector16(0 TO 15);  -- int16 [16]
  ...
  COMPONENT amc_cnn_8w16a_src_ParallelMACs_3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          vectorIn                        :   IN    vector_of_std_logic_vector16(0 TO 15);  -- int16 [16]
  ...
  COMPONENT amc_cnn_8w16a_src_ParallelMACs_4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          vectorIn                        :   IN    vector_of_std_logic_vector16(0 TO 15);  -- int16 [16]
  ...
  COMPONENT amc_cnn_8w16a_src_ParallelMACs_5
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          vectorIn                        :   IN    vector_of_std_logic_vector16(0 TO 15);  -- int16 [16]
  ...
  COMPONENT amc_cnn_8w16a_src_ParallelMACs_6
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          vectorIn                        :   IN    vector_of_std_logic_vector16(0 TO 15);  -- int16 [16]
  ...
  COMPONENT amc_cnn_8w16a_src_ParallelMACs_7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          vectorIn                        :   IN    vector_of_std_logic_vector16(0 TO 15);  -- int16 [16]
  ...
  COMPONENT amc_cnn_8w16a_src_ParallelMACs_8
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          vectorIn                        :   IN    vector_of_std_logic_vector16(0 TO 15);  -- int16 [16]
  ...
  COMPONENT amc_cnn_8w16a_src_ParallelMACs_9
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          vectorIn                        :   IN    vector_of_std_logic_vector16(0 TO 15);  -- int16 [16]
  ...
  COMPONENT amc_cnn_8w16a_src_ParallelMACs_10
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          vectorIn                        :   IN    vector_of_std_logic_vector16(0 TO 15);  -- int16 [16]
  ...
  COMPONENT amc_cnn_8w16a_src_ParallelMACs_11
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          vectorIn                        :   IN    vector_of_std_logic_vector16(0 TO 15);  -- int16 [16]
  ...
  COMPONENT amc_cnn_8w16a_src_ParallelMACs_12
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          vectorIn                        :   IN    vector_of_std_logic_vector16(0 TO 15);  -- int16 [16]
  ...
  COMPONENT amc_cnn_8w16a_src_ParallelMACs_13
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          vectorIn                        :   IN    vector_of_std_logic_vector16(0 TO 15);  -- int16 [16]
  ...
  COMPONENT amc_cnn_8w16a_src_ParallelMACs_14
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          vectorIn                        :   IN    vector_of_std_logic_vector16(0 TO 15);  -- int16 [16]
  ...
  COMPONENT amc_cnn_8w16a_src_ParallelMACs_15
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          vectorIn                        :   IN    vector_of_std_logic_vector16(0 TO 15);  -- int16 [16]
  ...
  FOR ALL : amc_cnn_8w16a_src_ParallelMACs_0
    USE ENTITY work.amc_cnn_8w16a_src_ParallelMACs_0(rtl);

  FOR ALL : amc_cnn_8w16a_src_ParallelMACs_1
    USE ENTITY work.amc_cnn_8w16a_src_ParallelMACs_1(rtl);

  FOR ALL : amc_cnn_8w16a_src_ParallelMACs_2
    USE ENTITY work.amc_cnn_8w16a_src_ParallelMACs_2(rtl);

  FOR ALL : amc_cnn_8w16a_src_ParallelMACs_3
    USE ENTITY work.amc_cnn_8w16a_src_ParallelMACs_3(rtl);

  FOR ALL : amc_cnn_8w16a_src_ParallelMACs_4
    USE ENTITY work.amc_cnn_8w16a_src_ParallelMACs_4(rtl);

  FOR ALL : amc_cnn_8w16a_src_ParallelMACs_5
    USE ENTITY work.amc_cnn_8w16a_src_ParallelMACs_5(rtl);

  FOR ALL : amc_cnn_8w16a_src_ParallelMACs_6
    USE ENTITY work.amc_cnn_8w16a_src_ParallelMACs_6(rtl);

  FOR ALL : amc_cnn_8w16a_src_ParallelMACs_7
    USE ENTITY work.amc_cnn_8w16a_src_ParallelMACs_7(rtl);

  FOR ALL : amc_cnn_8w16a_src_ParallelMACs_8
    USE ENTITY work.amc_cnn_8w16a_src_ParallelMACs_8(rtl);

  FOR ALL : amc_cnn_8w16a_src_ParallelMACs_9
    USE ENTITY work.amc_cnn_8w16a_src_ParallelMACs_9(rtl);

  FOR ALL : amc_cnn_8w16a_src_ParallelMACs_10
    USE ENTITY work.amc_cnn_8w16a_src_ParallelMACs_10(rtl);

  FOR ALL : amc_cnn_8w16a_src_ParallelMACs_11
    USE ENTITY work.amc_cnn_8w16a_src_ParallelMACs_11(rtl);

  FOR ALL : amc_cnn_8w16a_src_ParallelMACs_12
    USE ENTITY work.amc_cnn_8w16a_src_ParallelMACs_12(rtl);

  FOR ALL : amc_cnn_8w16a_src_ParallelMACs_13
    USE ENTITY work.amc_cnn_8w16a_src_ParallelMACs_13(rtl);

  FOR ALL : amc_cnn_8w16a_src_ParallelMACs_14
    USE ENTITY work.amc_cnn_8w16a_src_ParallelMACs_14(rtl);

  FOR ALL : amc_cnn_8w16a_src_ParallelMACs_15
    USE ENTITY work.amc_cnn_8w16a_src_ParallelMACs_15(rtl);
...
BEGIN
  ...
  u_ParallelMACs_0 : amc_cnn_8w16a_src_ParallelMACs_0
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_ParallelMACs_1 : amc_cnn_8w16a_src_ParallelMACs_1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_ParallelMACs_2 : amc_cnn_8w16a_src_ParallelMACs_2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_ParallelMACs_3 : amc_cnn_8w16a_src_ParallelMACs_3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_ParallelMACs_4 : amc_cnn_8w16a_src_ParallelMACs_4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_ParallelMACs_5 : amc_cnn_8w16a_src_ParallelMACs_5
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_ParallelMACs_6 : amc_cnn_8w16a_src_ParallelMACs_6
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_ParallelMACs_7 : amc_cnn_8w16a_src_ParallelMACs_7
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_ParallelMACs_8 : amc_cnn_8w16a_src_ParallelMACs_8
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_ParallelMACs_9 : amc_cnn_8w16a_src_ParallelMACs_9
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_ParallelMACs_10 : amc_cnn_8w16a_src_ParallelMACs_10
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_ParallelMACs_11 : amc_cnn_8w16a_src_ParallelMACs_11
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_ParallelMACs_12 : amc_cnn_8w16a_src_ParallelMACs_12
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_ParallelMACs_13 : amc_cnn_8w16a_src_ParallelMACs_13
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_ParallelMACs_14 : amc_cnn_8w16a_src_ParallelMACs_14
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_ParallelMACs_15 : amc_cnn_8w16a_src_ParallelMACs_15
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
