-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/amc_model_w8a16/amc_cnn_8w16a_src_adder_0_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_8w16a_src_adder_0_block
-- Source Path: amc_model_w8a16/DUT HDL/Conv Layer 1/Layer 1 Mat-Vec Multiplier/adder 0
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_8w16a_src_adder_0_block IS
...
END amc_cnn_8w16a_src_adder_0_block;


ARCHITECTURE rtl OF amc_cnn_8w16a_src_adder_0_block IS
  ...
  SIGNAL s_1                              : signed(23 DOWNTO 0);  -- sfix24_En6
  ...
  SIGNAL Multiply_Accumulate_multiply_out : signed(23 DOWNTO 0);  -- sfix24_En6
  SIGNAL Multiply_Accumulate_multiply_out_1 : signed(23 DOWNTO 0);  -- sfix24_En6
  SIGNAL Multiply_Accumulate_out1         : signed(23 DOWNTO 0);  -- sfix24_En6
  SIGNAL Multiply_Accumulate_add_fb_in    : signed(23 DOWNTO 0);  -- sfix24_En6
  SIGNAL Multiply_Accumulate_multiplyAdd_out : signed(23 DOWNTO 0);  -- sfix24_En6
  SIGNAL Multiply_Accumulate_out1_1       : signed(23 DOWNTO 0);  -- sfix24_En6
  SIGNAL Multiply_Accumulate_out3_buff_out_pipe_reg : vector_of_signed24(0 TO 1);  -- sfix24 [2]
  SIGNAL Multiply_Accumulate_out3_buff_out_pipe_reg_next : vector_of_signed24(0 TO 1);  -- sfix24_En6 [2]
  SIGNAL Multiply_Accumulate_out1_2       : signed(23 DOWNTO 0);  -- sfix24_En6
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Multiply_Accumulate_out1 <= to_signed(16#000000#, 24);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Multiply_Accumulate_out1_1 <= to_signed(16#000000#, 24);
      ELSIF enb = '1' THEN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Multiply_Accumulate_out3_buff_out_pipe_reg(0) <= to_signed(16#000000#, 24);
        Multiply_Accumulate_out3_buff_out_pipe_reg(1) <= to_signed(16#000000#, 24);
      ELSIF enb = '1' THEN
  ...
  Data_Type_Conversion_out1 <= Multiply_Accumulate_out1_2(13 DOWNTO 0) & '0' & '0';
