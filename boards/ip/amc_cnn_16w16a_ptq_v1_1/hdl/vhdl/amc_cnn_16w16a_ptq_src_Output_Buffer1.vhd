-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/model_pqt_2x2_w16a16/amc_cnn_16w16a_ptq_src_Output_Buffer1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_16w16a_ptq_src_Output_Buffer1
-- Source Path: model_pqt_2x2_w16a16/DUT HDL/Dense Layer 1/Output Buffer1
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_16w16a_ptq_src_Output_Buffer1 IS
...
END amc_cnn_16w16a_ptq_src_Output_Buffer1;


ARCHITECTURE rtl OF amc_cnn_16w16a_ptq_src_Output_Buffer1 IS

  -- Signals
  SIGNAL vectorIn_signed                  : vector_of_signed16(0 TO 127);  -- sfix16_En9 [128]
  ...
  SIGNAL buffer_next                      : vector_of_signed16(0 TO 127);  -- sfix16_En9 [128]
