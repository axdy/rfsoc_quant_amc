-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/model_pqt_2x2_w16a16/amc_cnn_16w16a_ptq_src_adder_5.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_16w16a_ptq_src_adder_5
-- Source Path: model_pqt_2x2_w16a16/DUT HDL/Dense Layer 2/Dense Layer 2/adder 5
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_16w16a_ptq_src_adder_5 IS
...
END amc_cnn_16w16a_ptq_src_adder_5;


ARCHITECTURE rtl OF amc_cnn_16w16a_ptq_src_adder_5 IS
  ...
  SIGNAL Multiply_Accumulate1_multiply_out : signed(31 DOWNTO 0);  -- sfix32_En24
  SIGNAL Multiply_Accumulate1_multiply_out_1 : signed(31 DOWNTO 0);  -- sfix32_En24
...
BEGIN
  ...
  Multiply_Accumulate1_add_add_cast_1 <= resize(Multiply_Accumulate1_multiply_out_1 & '0' & '0', 40);
