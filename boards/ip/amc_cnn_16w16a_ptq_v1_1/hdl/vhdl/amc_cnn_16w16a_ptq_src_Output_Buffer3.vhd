-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/model_pqt_2x2_w16a16/amc_cnn_16w16a_ptq_src_Output_Buffer3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_16w16a_ptq_src_Output_Buffer3
-- Source Path: model_pqt_2x2_w16a16/DUT HDL/Dense Layer 2/Output Buffer3
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_16w16a_ptq_src_Output_Buffer3 IS
...
END amc_cnn_16w16a_ptq_src_Output_Buffer3;


ARCHITECTURE rtl OF amc_cnn_16w16a_ptq_src_Output_Buffer3 IS

  -- Signals
  SIGNAL vectorIn_signed                  : vector_of_signed16(0 TO 7);  -- sfix16_En8 [8]
  ...
  SIGNAL buffer_next                      : vector_of_signed16(0 TO 7);  -- sfix16_En8 [8]
