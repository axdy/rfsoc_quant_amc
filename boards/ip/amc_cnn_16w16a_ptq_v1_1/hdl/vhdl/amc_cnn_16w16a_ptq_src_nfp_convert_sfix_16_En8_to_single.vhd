-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/model_pqt_2x2_w16a16/amc_cnn_16w16a_ptq_src_nfp_convert_sfix_16_En8_to_single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_16w16a_ptq_src_nfp_convert_sfix_16_En8_to_single
-- Source Path: model_pqt_2x2_w16a16/DUT HDL/nfp_convert_sfix_16_En8_to_single
-- Hierarchy Level: 1
-- 
...
ENTITY amc_cnn_16w16a_ptq_src_nfp_convert_sfix_16_En8_to_single IS
...
END amc_cnn_16w16a_ptq_src_nfp_convert_sfix_16_En8_to_single;


ARCHITECTURE rtl OF amc_cnn_16w16a_ptq_src_nfp_convert_sfix_16_En8_to_single IS

  -- Signals
  SIGNAL nfp_in_signed                    : signed(15 DOWNTO 0);  -- sfix16_En8
  ...
  SIGNAL Delay_out1_dtc                   : unsigned(15 DOWNTO 0);  -- ufix16_En8
  ...
  SIGNAL Unary_Minus_out1_dtc             : unsigned(15 DOWNTO 0);  -- ufix16_En8
  SIGNAL Switch_out1                      : unsigned(15 DOWNTO 0);  -- ufix16_En8
  SIGNAL Data_Type_Conversion_out1        : unsigned(127 DOWNTO 0);  -- ufix128_En8
  ...
  SIGNAL Delay2_reg_next                  : vector_of_unsigned128(0 TO 2);  -- ufix128_En8 [3]
  SIGNAL Delay2_out1_3                    : unsigned(127 DOWNTO 0);  -- ufix128_En8
  ...
  SIGNAL Shift_Arithmetic_out1            : unsigned(127 DOWNTO 0);  -- ufix128_En8
...
BEGIN
  ...
  Constant_out1 <= to_signed(16#76#, 8);
