-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/model_pqt_2x2_w16a16/amc_cnn_16w16a_ptq_src_adder_0_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_16w16a_ptq_src_adder_0_block
-- Source Path: model_pqt_2x2_w16a16/DUT HDL/Conv Layer 1/Layer 1 Mat-Vec Multiplier/adder 0
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_16w16a_ptq_src_adder_0_block IS
...
END amc_cnn_16w16a_ptq_src_adder_0_block;


ARCHITECTURE rtl OF amc_cnn_16w16a_ptq_src_adder_0_block IS
  ...
  SIGNAL Multiply_Accumulate_in1_buff_in_pipe_reg_next : vector_of_signed16(0 TO 1);  -- sfix16_En14 [2]
  SIGNAL In1_1                            : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL Multiply_Accumulate_multiply_out : signed(31 DOWNTO 0);  -- sfix32_En28
  SIGNAL Multiply_Accumulate_multiply_out_1 : signed(31 DOWNTO 0);  -- sfix32_En28
  ...
  SIGNAL Multiply_Accumulate_add_add_cast : signed(33 DOWNTO 0);  -- sfix34_En28
...
BEGIN
  ...
  Multiply_Accumulate_add_add_cast <= resize(Multiply_Accumulate_multiply_out_1, 34);
  Multiply_Accumulate_multiplyAdd_out <= Multiply_Accumulate_add_fb_in + Multiply_Accumulate_add_add_cast;
