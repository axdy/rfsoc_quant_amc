-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/model_qat_2x2_w16a16/amc_cnn_qat_16w16a_src_adder_0_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_qat_16w16a_src_adder_0_block1
-- Source Path: model_qat_2x2_w16a16/DUT HDL/Dense Layer 1/Dense Layer 1/adder 0
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_qat_16w16a_src_adder_0_block1 IS
...
END amc_cnn_qat_16w16a_src_adder_0_block1;


ARCHITECTURE rtl OF amc_cnn_qat_16w16a_src_adder_0_block1 IS
  ...
  SIGNAL Multiply_Accumulate_multiply_out : signed(31 DOWNTO 0);  -- sfix32_En30
  SIGNAL Multiply_Accumulate_multiply_out_1 : signed(31 DOWNTO 0);  -- sfix32_En30
...
BEGIN
  ...
  Multiply_Accumulate_add_add_cast_1 <= resize(Multiply_Accumulate_multiply_out_1 & '0' & '0' & '0' & '0' & '0' & '0' & '0' & '0', 58);
