-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/model_qat_2x2_w16a16/amc_cnn_qat_16w16a_src_adder_6.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_qat_16w16a_src_adder_6
-- Source Path: model_qat_2x2_w16a16/DUT HDL/Dense Layer 2/Dense Layer 2/adder 6
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_qat_16w16a_src_adder_6 IS
...
END amc_cnn_qat_16w16a_src_adder_6;


ARCHITECTURE rtl OF amc_cnn_qat_16w16a_src_adder_6 IS
  ...
  SIGNAL s_2                              : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL Multiply_Accumulate1_input_mux_out : signed(15 DOWNTO 0);  -- sfix16_En12
  SIGNAL In1_signed                       : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL Multiply_Accumulate1_multiply_out : signed(31 DOWNTO 0);  -- sfix32_En27
  SIGNAL Multiply_Accumulate1_multiply_out_1 : signed(31 DOWNTO 0);  -- sfix32_En27
  ...
  SIGNAL Multiply_Accumulate1_add_add_cast : signed(40 DOWNTO 0);  -- sfix41_En27
  SIGNAL Multiply_Accumulate1_add_add_cast_1 : signed(40 DOWNTO 0);  -- sfix41_En27
  SIGNAL Multiply_Accumulate1_add_add_temp : signed(40 DOWNTO 0);  -- sfix41_En27
...
BEGIN
  ...
  Multiply_Accumulate1_add_add_cast <= resize(Multiply_Accumulate1_add_fb_in & '0', 41);
  Multiply_Accumulate1_add_add_cast_1 <= resize(Multiply_Accumulate1_multiply_out_1, 41);
  Multiply_Accumulate1_add_add_temp <= Multiply_Accumulate1_add_add_cast + Multiply_Accumulate1_add_add_cast_1;
  Multiply_Accumulate1_multiplyAdd_out <= Multiply_Accumulate1_add_add_temp(39 DOWNTO 1);
