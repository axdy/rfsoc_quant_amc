-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/model_qat_2x2_w16a16/amc_cnn_qat_16w16a_src_MAC13_block14.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_qat_16w16a_src_MAC13_block14
-- Source Path: model_qat_2x2_w16a16/DUT HDL/Conv Layer 2/Filter Matrix Multiplier1/ParallelMACs 9/MAC13
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_qat_16w16a_src_MAC13_block14 IS
...
END amc_cnn_qat_16w16a_src_MAC13_block14;


ARCHITECTURE rtl OF amc_cnn_qat_16w16a_src_MAC13_block14 IS
  ...
  SIGNAL Multiply_Accumulate_multiply_out : signed(31 DOWNTO 0);  -- sfix32_En29
  SIGNAL Multiply_Accumulate_multiply_out_1 : signed(31 DOWNTO 0);  -- sfix32_En29
...
BEGIN
  ...
  Multiply_Accumulate_add_add_cast_1 <= resize(Multiply_Accumulate_multiply_out_1 & '0', 42);
