-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/model_pqt_2x2_w2a16/amc_cnn_2w16a_ptq_src_Output_Buffer3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_2w16a_ptq_src_Output_Buffer3
-- Source Path: model_pqt_2x2_w2a16/DUT HDL/Dense Layer 2/Output Buffer3
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_2w16a_ptq_src_Output_Buffer3 IS
...
END amc_cnn_2w16a_ptq_src_Output_Buffer3;


ARCHITECTURE rtl OF amc_cnn_2w16a_ptq_src_Output_Buffer3 IS

  -- Signals
  SIGNAL vectorIn_signed                  : vector_of_signed16(0 TO 7);  -- sfix16_En9 [8]
  SIGNAL samplesOut_tmp                   : signed(15 DOWNTO 0);  -- sfix16_En9
  SIGNAL reg_flag                         : std_logic;
  SIGNAL reg_count_out                    : unsigned(3 DOWNTO 0);  -- ufix4
  SIGNAL buffer_rsvd                      : vector_of_signed16(0 TO 7);  -- sfix16 [8]
  SIGNAL reg_flag_next                    : std_logic;
  SIGNAL reg_count_out_next               : unsigned(3 DOWNTO 0);  -- ufix4
  SIGNAL buffer_next                      : vector_of_signed16(0 TO 7);  -- sfix16_En9 [8]
