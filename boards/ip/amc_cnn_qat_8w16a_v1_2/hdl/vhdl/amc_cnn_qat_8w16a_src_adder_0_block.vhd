-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/model_qat_2x2_w8a16/amc_cnn_qat_8w16a_src_adder_0_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_qat_8w16a_src_adder_0_block
-- Source Path: model_qat_2x2_w8a16/DUT HDL/Conv Layer 1/Layer 1 Mat-Vec Multiplier/adder 0
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_qat_8w16a_src_adder_0_block IS
...
END amc_cnn_qat_8w16a_src_adder_0_block;


ARCHITECTURE rtl OF amc_cnn_qat_8w16a_src_adder_0_block IS
  ...
  SIGNAL In1_signed                       : signed(7 DOWNTO 0);  -- sfix8_En6
  SIGNAL Multiply_Accumulate_in1_buff_in_pipe_reg : vector_of_signed8(0 TO 1);  -- sfix8 [2]
  SIGNAL Multiply_Accumulate_in1_buff_in_pipe_reg_next : vector_of_signed8(0 TO 1);  -- sfix8_En6 [2]
  SIGNAL In1_1                            : signed(7 DOWNTO 0);  -- sfix8_En6
  SIGNAL Multiply_Accumulate_multiply_out : signed(23 DOWNTO 0);  -- sfix24_En20
  SIGNAL Multiply_Accumulate_multiply_out_1 : signed(23 DOWNTO 0);  -- sfix24_En20
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Multiply_Accumulate_in1_buff_in_pipe_reg(0) <= to_signed(16#00#, 8);
        Multiply_Accumulate_in1_buff_in_pipe_reg(1) <= to_signed(16#00#, 8);
      ELSIF enb = '1' THEN
  ...
  Multiply_Accumulate_add_add_cast_1 <= resize(Multiply_Accumulate_multiply_out_1 & '0' & '0' & '0' & '0' & '0' & '0' & '0' & '0', 35);
