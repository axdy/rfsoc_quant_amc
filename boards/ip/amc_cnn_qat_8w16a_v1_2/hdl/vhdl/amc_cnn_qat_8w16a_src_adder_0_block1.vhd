-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/model_qat_2x2_w8a16/amc_cnn_qat_8w16a_src_adder_0_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_qat_8w16a_src_adder_0_block1
-- Source Path: model_qat_2x2_w8a16/DUT HDL/Dense Layer 1/Dense Layer 1/adder 0
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_qat_8w16a_src_adder_0_block1 IS
...
END amc_cnn_qat_8w16a_src_adder_0_block1;


ARCHITECTURE rtl OF amc_cnn_qat_8w16a_src_adder_0_block1 IS
  ...
  SIGNAL Multiply_Accumulate_in0_buff_in_pipe_reg_next : vector_of_signed16(0 TO 1);  -- sfix16_En13 [2]
  SIGNAL In2_1                            : signed(15 DOWNTO 0);  -- sfix16_En13
  SIGNAL s_2                              : signed(15 DOWNTO 0);  -- sfix16_En13
  SIGNAL Multiply_Accumulate_input_mux_out : signed(15 DOWNTO 0);  -- sfix16_En13
  SIGNAL In1_signed                       : signed(7 DOWNTO 0);  -- sfix8_En8
  SIGNAL Multiply_Accumulate_in1_buff_in_pipe_reg : vector_of_signed8(0 TO 1);  -- sfix8 [2]
  SIGNAL Multiply_Accumulate_in1_buff_in_pipe_reg_next : vector_of_signed8(0 TO 1);  -- sfix8_En8 [2]
  SIGNAL In1_1                            : signed(7 DOWNTO 0);  -- sfix8_En8
