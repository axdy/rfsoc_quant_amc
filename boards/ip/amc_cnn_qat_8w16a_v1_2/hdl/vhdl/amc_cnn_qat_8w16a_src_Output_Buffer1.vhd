-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/model_qat_2x2_w8a16/amc_cnn_qat_8w16a_src_Output_Buffer1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_qat_8w16a_src_Output_Buffer1
-- Source Path: model_qat_2x2_w8a16/DUT HDL/Dense Layer 1/Output Buffer1
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_qat_8w16a_src_Output_Buffer1 IS
...
END amc_cnn_qat_8w16a_src_Output_Buffer1;


ARCHITECTURE rtl OF amc_cnn_qat_8w16a_src_Output_Buffer1 IS

  -- Signals
  SIGNAL vectorIn_signed                  : vector_of_signed57(0 TO 127);  -- sfix57_En38 [128]
  SIGNAL samplesOut_tmp                   : signed(56 DOWNTO 0);  -- sfix57_En38
  SIGNAL reg_flag                         : std_logic;
  SIGNAL reg_count_out                    : unsigned(7 DOWNTO 0);  -- ufix8
  SIGNAL buffer_rsvd                      : vector_of_signed57(0 TO 127);  -- sfix57 [128]
  SIGNAL reg_flag_next                    : std_logic;
  SIGNAL reg_count_out_next               : unsigned(7 DOWNTO 0);  -- ufix8
  SIGNAL buffer_next                      : vector_of_signed57(0 TO 127);  -- sfix57_En38 [128]
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        ...
        buffer_rsvd <= (OTHERS => to_signed(0, 57));
      ELSIF enb = '1' THEN
  ...
  Output_Buffer1_output : PROCESS (buffer_rsvd, reg_count_out, reg_flag, validIn, vectorIn_signed)
    ...
    VARIABLE buffer_temp : vector_of_signed57(0 TO 127);
