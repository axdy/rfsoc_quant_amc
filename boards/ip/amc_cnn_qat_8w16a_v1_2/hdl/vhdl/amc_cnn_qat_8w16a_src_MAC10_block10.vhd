-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/model_qat_2x2_w8a16/amc_cnn_qat_8w16a_src_MAC10_block10.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_qat_8w16a_src_MAC10_block10
-- Source Path: model_qat_2x2_w8a16/DUT HDL/Conv Layer 2/Filter Matrix Multiplier1/ParallelMACs 5/MAC10
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_qat_8w16a_src_MAC10_block10 IS
...
END amc_cnn_qat_8w16a_src_MAC10_block10;


ARCHITECTURE rtl OF amc_cnn_qat_8w16a_src_MAC10_block10 IS
  ...
  SIGNAL Multiply_Accumulate_multiply_out_1 : signed(23 DOWNTO 0);  -- sfix24_En22
...
BEGIN
  ...
  Multiply_Accumulate_add_add_cast_1 <= resize(Multiply_Accumulate_multiply_out_1 & '0' & '0' & '0' & '0' & '0' & '0' & '0' & '0', 42);
