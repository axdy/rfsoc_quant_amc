-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/model_qat_2x2_w8a16/amc_cnn_qat_8w16a_src_Ping_Pong_Buffer_Controller.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_qat_8w16a_src_Ping_Pong_Buffer_Controller
-- Source Path: model_qat_2x2_w8a16/DUT HDL/Collect Input into Bursts/Ping Pong Buffer Controller
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_qat_8w16a_src_Ping_Pong_Buffer_Controller IS
...
END amc_cnn_qat_8w16a_src_Ping_Pong_Buffer_Controller;


ARCHITECTURE rtl OF amc_cnn_qat_8w16a_src_Ping_Pong_Buffer_Controller IS
