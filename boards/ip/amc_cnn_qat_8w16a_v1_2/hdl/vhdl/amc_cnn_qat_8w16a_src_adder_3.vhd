-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/model_qat_2x2_w8a16/amc_cnn_qat_8w16a_src_adder_3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: amc_cnn_qat_8w16a_src_adder_3
-- Source Path: model_qat_2x2_w8a16/DUT HDL/Dense Layer 2/Dense Layer 2/adder 3
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY amc_cnn_qat_8w16a_src_adder_3 IS
...
END amc_cnn_qat_8w16a_src_adder_3;


ARCHITECTURE rtl OF amc_cnn_qat_8w16a_src_adder_3 IS
  ...
  SIGNAL Multiply_Accumulate1_input_mux_out : signed(15 DOWNTO 0);  -- sfix16_En11
  SIGNAL In1_signed                       : signed(7 DOWNTO 0);  -- sfix8_En7
  SIGNAL Multiply_Accumulate1_multiply_out : signed(23 DOWNTO 0);  -- sfix24_En18
  SIGNAL Multiply_Accumulate1_multiply_out_1 : signed(23 DOWNTO 0);  -- sfix24_En18
...
BEGIN
  ...
  Multiply_Accumulate1_add_add_cast_1 <= resize(Multiply_Accumulate1_multiply_out_1 & '0' & '0' & '0' & '0' & '0' & '0' & '0' & '0', 40);
