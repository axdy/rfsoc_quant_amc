...
user.org:ip:amc_cnn_4w16a:1.0\
user.org:ip:amc_cnn_8w16a:1.0\
...
proc create_hier_cell_transmitter { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_1_M02_AXI [get_bd_intf_pins M02_AXI] [get_bd_intf_pins ps8_0_axi_periph_1/M02_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_1_M03_AXI [get_bd_intf_pins M03_AXI] [get_bd_intf_pins ps8_0_axi_periph_1/M03_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_1_M04_AXI [get_bd_intf_pins M04_AXI] [get_bd_intf_pins ps8_0_axi_periph_1/M04_AXI]
  ...
  # Create port connections
  connect_bd_net -net M02_ACLK_1 [get_bd_pins M02_ACLK] [get_bd_pins ps8_0_axi_periph_1/M02_ACLK] [get_bd_pins ps8_0_axi_periph_1/M03_ACLK] [get_bd_pins ps8_0_axi_periph_1/M04_ACLK]
  connect_bd_net -net M02_ARESETN_1 [get_bd_pins M02_ARESETN] [get_bd_pins ps8_0_axi_periph_1/M02_ARESETN] [get_bd_pins ps8_0_axi_periph_1/M03_ARESETN] [get_bd_pins ps8_0_axi_periph_1/M04_ARESETN]
...
proc create_hier_cell_receiver { parentCell nameHier } {
  ...
  set amc_cnn_16w16a [ create_bd_cell -type ip -vlnv user.org:ip:amc_cnn_16w16a:1.1 amc_cnn_16w16a ]

  # Create instance: amc_cnn_4w_16a, and set properties
  set amc_cnn_4w_16a [ create_bd_cell -type ip -vlnv user.org:ip:amc_cnn_4w16a:1.0 amc_cnn_4w_16a ]

  # Create instance: amc_cnn_8w16a, and set properties
  set amc_cnn_8w16a [ create_bd_cell -type ip -vlnv user.org:ip:amc_cnn_8w16a:1.0 amc_cnn_8w16a ]
  ...
  connect_bd_intf_net -intf_net AXI4_Lite6_1 [get_bd_intf_pins AXI4_Lite6] [get_bd_intf_pins amc_cnn_4w_16a/AXI4_Lite]
  connect_bd_intf_net -intf_net AXI4_Lite7_1 [get_bd_intf_pins AXI4_Lite7] [get_bd_intf_pins amc_cnn_8w16a/AXI4_Lite]
  connect_bd_intf_net -intf_net AXI4_Lite8_1 [get_bd_intf_pins AXI4_Lite8] [get_bd_intf_pins amc_cnn_16w16a/AXI4_Lite]
  ...
  connect_bd_intf_net -intf_net amc_cnn_16w16a_AXI4_Stream_Master [get_bd_intf_pins amc_cnn_16w16a/AXI4_Stream_Master] [get_bd_intf_pins dma_controller_0/AXI4_Stream_Slave]
  ...
  connect_bd_intf_net -intf_net amc_cnn_dma_0_AXI4_Stream_Master [get_bd_intf_pins amc_cnn_4w_16a/AXI4_Stream_Master] [get_bd_intf_pins dma_controller_2/AXI4_Stream_Slave]
  connect_bd_intf_net -intf_net [get_bd_intf_nets amc_cnn_dma_0_AXI4_Stream_Master] [get_bd_intf_pins AXI4_Stream_Master1] [get_bd_intf_pins amc_cnn_4w_16a/AXI4_Stream_Master]
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets amc_cnn_out] [get_bd_intf_pins AXI4_Stream_Master] [get_bd_intf_pins axis_data_fifo_2/M_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_broadcaster_1_M02_AXIS [get_bd_intf_pins amc_cnn_4w_16a/AXI4_Stream_Slave] [get_bd_intf_pins axis_broadcaster_1/M02_AXIS]
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets dma_controller_AXI4_Stream_Master] [get_bd_intf_pins AXI4_Stream_Master2] [get_bd_intf_pins dma_controller_2/AXI4_Stream_Master]
  ...
  # Create port connections
  connect_bd_net -net M00_ARESETN_1 [get_bd_pins aresetn] [get_bd_pins Interleave_IQ/AXI4_Lite_ARESETN] [get_bd_pins Interleave_IQ/IPCORE_RESETN] [get_bd_pins amc_cnn_16w16a/AXI4_Lite_ARESETN] [get_bd_pins amc_cnn_16w16a/IPCORE_RESETN] [get_bd_pins amc_cnn_4w_16a/AXI4_Lite_ARESETN] [get_bd_pins amc_cnn_4w_16a/IPCORE_RESETN] [get_bd_pins amc_cnn_8w16a/AXI4_Lite_ARESETN] [get_bd_pins amc_cnn_8w16a/IPCORE_RESETN] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_broadcaster_1/aresetn] [get_bd_pins axis_clock_converter_0/s_axis_aresetn] [get_bd_pins axis_clock_converter_1/s_axis_aresetn] [get_bd_pins axis_clock_converter_2/s_axis_aresetn] [get_bd_pins axis_clock_converter_pkt/s_axis_aresetn] [get_bd_pins axis_combiner_0/aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins axis_data_fifo_1/s_axis_aresetn] [get_bd_pins axis_data_fifo_2/s_axis_aresetn] [get_bd_pins dma_controller_0/AXI4_Lite_ARESETN] [get_bd_pins dma_controller_0/IPCORE_RESETN] [get_bd_pins dma_controller_1/AXI4_Lite_ARESETN] [get_bd_pins dma_controller_1/IPCORE_RESETN] [get_bd_pins dma_controller_2/AXI4_Lite_ARESETN] [get_bd_pins dma_controller_2/IPCORE_RESETN] [get_bd_pins packet_generator/AXI4_Lite_ARESETN] [get_bd_pins packet_generator/IPCORE_RESETN]
  connect_bd_net -net adc0_clk_wiz_clk_out1 [get_bd_pins aclk] [get_bd_pins Interleave_IQ/AXI4_Lite_ACLK] [get_bd_pins Interleave_IQ/IPCORE_CLK] [get_bd_pins amc_cnn_16w16a/AXI4_Lite_ACLK] [get_bd_pins amc_cnn_16w16a/IPCORE_CLK] [get_bd_pins amc_cnn_4w_16a/AXI4_Lite_ACLK] [get_bd_pins amc_cnn_4w_16a/IPCORE_CLK] [get_bd_pins amc_cnn_8w16a/AXI4_Lite_ACLK] [get_bd_pins amc_cnn_8w16a/IPCORE_CLK] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_broadcaster_1/aclk] [get_bd_pins axis_clock_converter_0/s_axis_aclk] [get_bd_pins axis_clock_converter_1/s_axis_aclk] [get_bd_pins axis_clock_converter_2/s_axis_aclk] [get_bd_pins axis_clock_converter_pkt/s_axis_aclk] [get_bd_pins axis_combiner_0/aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_data_fifo_1/s_axis_aclk] [get_bd_pins axis_data_fifo_2/s_axis_aclk] [get_bd_pins dma_controller_0/AXI4_Lite_ACLK] [get_bd_pins dma_controller_0/IPCORE_CLK] [get_bd_pins dma_controller_1/AXI4_Lite_ACLK] [get_bd_pins dma_controller_1/IPCORE_CLK] [get_bd_pins dma_controller_2/AXI4_Lite_ACLK] [get_bd_pins dma_controller_2/IPCORE_CLK] [get_bd_pins fir_decim_imag/aclk] [get_bd_pins fir_decim_real/aclk] [get_bd_pins packet_generator/AXI4_Lite_ACLK] [get_bd_pins packet_generator/IPCORE_CLK]
  connect_bd_net -net amc_cnn_4w16a_0_sampleNum [get_bd_pins sampleNum1] [get_bd_pins amc_cnn_4w_16a/sampleNum]
  connect_bd_net -net amc_cnn_4w16a_0_validConv1 [get_bd_pins validConv3] [get_bd_pins amc_cnn_4w_16a/validConv1]
  connect_bd_net -net amc_cnn_4w16a_0_validConv2 [get_bd_pins validConv4] [get_bd_pins amc_cnn_4w_16a/validConv2]
  connect_bd_net -net amc_cnn_4w16a_0_validDense1 [get_bd_pins validDense2] [get_bd_pins amc_cnn_4w_16a/validDense1]
  connect_bd_net -net amc_cnn_4w16a_0_validInput [get_bd_pins validInput1] [get_bd_pins amc_cnn_4w_16a/validInput]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets rfdc_real] [get_bd_intf_pins receiver/S00_AXIS] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]
  ...
  connect_bd_intf_net -intf_net transmitter_M02_AXI [get_bd_intf_pins receiver/AXI4_Lite6] [get_bd_intf_pins transmitter/M02_AXI]
  connect_bd_intf_net -intf_net transmitter_M03_AXI [get_bd_intf_pins receiver/AXI4_Lite7] [get_bd_intf_pins transmitter/M03_AXI]
  connect_bd_intf_net -intf_net transmitter_M04_AXI [get_bd_intf_pins receiver/AXI4_Lite8] [get_bd_intf_pins transmitter/M04_AXI]
  ...
  # Create port connections
  connect_bd_net -net M00_ARESETN_1 [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/M04_ARESETN] [get_bd_pins ps8_0_axi_periph/M06_ARESETN] [get_bd_pins ps8_0_axi_periph/M08_ARESETN] [get_bd_pins ps8_0_axi_periph/M09_ARESETN] [get_bd_pins receiver/aresetn] [get_bd_pins rst_adc0_clk_wiz_128M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn] [get_bd_pins transmitter/M02_ARESETN] [get_bd_pins usp_rf_data_converter_0/m0_axis_aresetn]
  ...
  connect_bd_net -net adc0_clk_wiz_clk_out1 [get_bd_pins adc0_clk_wiz/clk_out1] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins ps8_0_axi_periph/M04_ACLK] [get_bd_pins ps8_0_axi_periph/M06_ACLK] [get_bd_pins ps8_0_axi_periph/M08_ACLK] [get_bd_pins ps8_0_axi_periph/M09_ACLK] [get_bd_pins receiver/aclk] [get_bd_pins rst_adc0_clk_wiz_128M/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins transmitter/M02_ACLK] [get_bd_pins usp_rf_data_converter_0/m0_axis_aclk]
  ...
  assign_bd_address -offset 0xB0040000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs receiver/amc_cnn_16w16a/AXI4_Lite/reg0] -force
  assign_bd_address -offset 0xB0020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs receiver/amc_cnn_4w_16a/AXI4_Lite/reg0] -force
  assign_bd_address -offset 0xB0030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs receiver/amc_cnn_8w16a/AXI4_Lite/reg0] -force
  ...
  assign_bd_address -offset 0xA00B0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs receiver/dma_controller_0/AXI4_Lite/reg0] -force
  assign_bd_address -offset 0xA00C0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs receiver/dma_controller_1/AXI4_Lite/reg0] -force
  assign_bd_address -offset 0xA0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs receiver/dma_controller_2/AXI4_Lite/reg0] -force
  ...
  assign_bd_address -offset 0xA0020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs receiver/rx_dma_0/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0xA0030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs receiver/rx_dma_1/S_AXI_LITE/Reg] -force
  ...
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces receiver/rx_dma_0/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_HIGH]
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces receiver/rx_dma_0/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_HIGH]
  ...
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces receiver/rx_dma_0/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM]
  ...
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces receiver/rx_dma_pkt/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_HIGH]
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces receiver/rx_dma_pkt/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_HIGH]
  ...
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces receiver/rx_dma_pkt/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM]
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces receiver/rx_dma_pkt/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM]
